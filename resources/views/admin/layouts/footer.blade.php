...
<!-- CK Editor -->
<script src="{{url('design/adminlte/bower_components/ckeditor/ckeditor.js')}}"></script>
...
<script src="{{url('design/adminlte/bower_components/jquery/dist/jquery.min.js')}}"></script>
<!-- Bootstrap 3.3.7 -->
<script src="{{url('desin/adminlte/}bower_components/bootstrap/dist/js/bootstrap.min.js')}}"></script>
